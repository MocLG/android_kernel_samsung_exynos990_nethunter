...
SEARCH_DIR("/root/llvm-tc-build/install/x86_64-pep/lib"); SEARCH_DIR("/root/llvm-tc-build/install/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
