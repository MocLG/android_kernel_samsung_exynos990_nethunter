...
* **HID Support:** Keyboard/Mouse hijacking (BadUSB/Rubber Ducky attacks). (Not compatible with ADB)
* **DriveDroid Support:** Use your phone as a bootable USB drive. (Not compatible with ADB)
